...
namespace System
{
    ...
    {
        internal string newJson(List<SquareMinecraftLauncher.Core.Forge.ForgeY.LibrariesItem> libraries, string Arguments, string mainClass, SquareMinecraftLauncher.Core.Forge.ForgeY.Root r)
        {
