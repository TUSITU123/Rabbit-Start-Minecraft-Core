...
namespace System
{
    internal class fabricUninstall : NewJson
    {
        ...
        internal string Uninstall(string version)
        {
            ...
            return newJson(libraries, Arg, mainClass, JsonConvert.DeserializeObject<SquareMinecraftLauncher.Core.Forge.ForgeY.Root>(json));
        }

        List<SquareMinecraftLauncher.Core.Forge.ForgeY.LibrariesItem> librariesJson(string json)
        {
            var libraries = JsonConvert.DeserializeObject<SquareMinecraftLauncher.Core.Forge.ForgeY.Root>(json);
            List<SquareMinecraftLauncher.Core.Forge.ForgeY.LibrariesItem> librariesItems = new List<SquareMinecraftLauncher.Core.Forge.ForgeY.LibrariesItem>();
        ...
        {
            fabricmcInstall fbricmcInstall = new fabricmcInstall();
            string Arg = fbricmcInstall.ArgumentsJson(json);
        ...
        {
            var Json = JsonConvert.DeserializeObject<SquareMinecraftLauncher.Core.Forge.ForgeY.Root>(json);
