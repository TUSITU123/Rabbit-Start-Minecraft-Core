...
namespace FastX.Core.Helpers
{
    public class DownloadThread
    {
        ...
        private FileDownloadModel downloader;

        public DownloadThread(FileDownloadModel downloader, string downUrl, string saveFile, long block, long downLength, int threadId)
        {
